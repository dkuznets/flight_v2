...
/* Add-on CAN function (by A.Kozyrev)                                        */
extern CAN_ERROR CAN_hw_tx_empty_keep_state(U32 ctrl);
extern CAN_ERROR CAN_hw_tx_abort(U32 ctrl);
extern U8        CAN_hw_rx_get_err_counter(U32 ctrl);
extern U8        CAN_hw_tx_get_err_counter(U32 ctrl);
extern void      CAN_hw_tx_reset_err_counter(U32 ctrl);
extern void      CAN_hw_rx_reset_err_counter(U32 ctrl);
extern void      CAN_hw_clear_reset_mode(U32 ctrl);
